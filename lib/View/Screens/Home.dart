import 'package:bagas_AAS/View/Component/Category.dart';
import 'package:bagas_AAS/View/Screens/Detail.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color.fromARGB(164, 133, 211, 31),
        elevation: 0,
        title: const Text(
          'TOKO ELEKTRONIK',
          style: TextStyle(color: Color.fromARGB(255, 247, 243, 243), fontWeight: FontWeight.w600),
        ),
      ),
      body: Column(
        children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      maxLines: 1,
                                      style: const TextStyle(
                                          color: Color.fromARGB(255, 238, 252, 50),
                                          fontWeight: FontWeight.w600),
                                    ),
                                  ],  
                                ),
